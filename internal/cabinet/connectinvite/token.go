...
// DefaultTTL — срок жизни приглашения. Неделя: получателю хватает поставить
// приложение не в тот же вечер, а забытая в переписке ссылка перестаёт
// работать без участия владельца.
