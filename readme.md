...
- **Админ-статистика**: при `ADMIN_TELEGRAM_ID` в админ-панели — раздел со сводками по БД (пользователи, подписки, доходы в ₽, рефералы в днях, общая сводка, **статистика колеса фортуны**)
