...
func main() {
	...
	// экраны читают журнал, а не пересчитывают историю из purchase. Признак
	// «уже выполнялся» — наличие строк с is_backfilled, а не пустота таблицы,
	// поэтому повторные старты бота ничего не задваивают.
